...
export default class HierarchicalRefinementFilter extends SearchkitComponent<HierarchicalRefinementFilterProps, any> {
  ...
  renderOption(level, option) {
    ...
    var isWeekend = (option.key.indexOf('Saturday') !== -1 || option.key.indexOf('Sunday') !== -1)
